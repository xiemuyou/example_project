package com.doushi.library.widgets.imagepreview.wight;
...
import com.doushi.library.widgets.imagepreview.photoview.PhotoView;
...
public class SmoothImageView extends PhotoView {
    ...
    private static final float MAX_TRANS_SCALE = 0.3f;
    @Override
    ...
    private void initTransform() {
        ...
        if (drawable instanceof BitmapDrawable) {
            ...
            Bitmap mBitmap = ((GifDrawable) drawable).getFirstFrame();
            if(mBitmap != null){
                bitmapWidth = mBitmap.getWidth();
                bitmapHeight = mBitmap.getHeight();
            }
        }else{
            Bitmap mBitmap = Bitmap.createBitmap(drawable.getIntrinsicWidth(),
