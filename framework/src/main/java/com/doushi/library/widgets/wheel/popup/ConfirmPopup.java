package com.doushi.library.widgets.wheel.popup;
...
import com.doushi.library.widgets.wheel.util.ConvertUtils;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        if (cancelTextSize != 0) {
            cancelButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, cancelTextSize);
        }
        ...
        if (submitTextSize != 0) {
            submitButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, submitTextSize);
        }
