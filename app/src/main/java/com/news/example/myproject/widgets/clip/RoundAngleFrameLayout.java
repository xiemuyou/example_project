package com.news.example.myproject.widgets.clip;
...
/**
 * 圆角FrameLayout
 * https://github.com/Y-bao/RoundAngleFrameLayout/tree/master/app/src/main
 *
 * @author ybao
 * @date 2018/7/4
 */
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    public RoundAngleFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            @SuppressLint("CustomViewStyleable") TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ClipView);
            float radius = ta.getDimension(R.styleable.ClipView_radiusSize, 0);
            topLeftRadius = ta.getDimension(R.styleable.ClipView_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.ClipView_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.ClipView_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.ClipView_bottomRightRadius, radius);
            ta.recycle();
        }
