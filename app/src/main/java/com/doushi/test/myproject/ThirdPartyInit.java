...
//                }).initialize();
     ...
     */
    private void initLitePal(Application context) {
    ...
    private void initOkGo(Application context) {
        ...
        try {
            ...
            //log相关
            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor("SanTong");
     ...
     * 初始化异常捕获
     */
    private void initCrashHandler(Application context) {
//        CrashHandler.getInstance().init(context);
     ...
     * 初始化内存泄漏测试
     */
    private void initLeakCanary(Application context) {
...
//        LeakCanary.install(context);
     ...
     */
    private void initPcdn(Application context) {
//        BaseUtils.init(context);
     ...
     * @param context Application上下文对象
     */
    private void initMob(Application context) {
//        MobSDK.init(context, "MobAppkey", "MobAppsecret");
     ...
     * 初始化极光推送
     */
    private void initJPush(Application context) {
//        //极光推送
//        // 设置开启日志,发布时请关闭日志
...
//        JPushInterface.init(context);
     ...
     * @param context Application上下文对象
     */
    private void initImageLoader(Application context) {
...
//        ImageLoader.getInstance().init(config);
    ...
    private void initTencentX5(Application context) {
